...
/*   Updated: 2025/12/01 16:15:58 by keitotak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_pipex_exp(void)
{
	...
	ft_putendl_fd("\e[32mUsage example:\t./pipex file1 <cmd1> <cmd2> file2", 1);
	ft_putendl_fd("\t$ ./pipex infile \"ls -l\" \"wc -l\" outfile\e[0m", 1);
	ft_putendl_fd("", 1);
}
